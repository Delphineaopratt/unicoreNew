        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              // Card number shows if card payment is selected
              {paymentMethod === "card" && (
                <div className="ml-7">
              ...
              // Mobile money instructions show if mobile money is selected
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              >
                ...
                policy, and house rules. I understand that payment is required
